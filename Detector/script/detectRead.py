...
def threeWindows(dfMuonPos, winMin, winGap):
    ...
    def plotting(data, eveID, i):
        pos3D.scatter(data["hitPosX"],data["hitPosY"],data["hitPosZ"], color=c_lst[i])
        pos2DXY.scatter(data["hitPosX"],data["hitPosY"], color=c_lst[i])
        pos2DVZ.scatter(data["VolID"],data["hitPosZ"], color=c_lst[i])
        pos2DVT.scatter(data["VolID"],data["hitTime"], color=c_lst[i])
        eveID = eveID.values
    ...
    def plotSel(dfSel):
        ...
        pos2DVT.scatter(dfSel["VolID"],dfSel["hitTime"], color='red', linestyle= 'dashed', marker='o')
