...
def rawDataPlot(timeBinMin, timeBinMax, data1, data2, data1HitCut, data2HitCut):
    ...
    timeMin = data1["hitTime"].min()
    timeMax = data1["hitTime"].max()
    ...
    winLine(data1, winTimeRange)
    
    dfeveSel = histHits(histAll, data1, data1HitCut)
    dfeveSelCut = histHits(histMom ,data2, data2HitCut)
    ...
    plotSel(dfeveSel, data1, "b-", "blue")
    plotSel(dfeveSelCut, data2, "r-", "red")
