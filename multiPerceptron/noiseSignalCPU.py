...
signalTrain, noiseTrain = noiseSignalModules.momLabelSigNoise(fileName1, momCutMin, momCutMax ,rCut)
signalTest, noiseTest = noiseSignalModules.momLabelSigNoise(fileName2, momCutMin, momCutMax ,rCut)

def dataPre(Track1, Track2):
    TrackSum = pd.concat([Track1, Track2])
...
X_train , y_train , size_train = dataPre(signalTrain, noiseTrain)   
X_test , y_test , size_test    = dataPre(signalTest, noiseTest)
