...
print("reading..")
def momLabelSigNoise(name, momCutmin, momCutmax,Rcut):
#def momLabel(name, momCutmin, momCutmax,Rcut, labelID):
    ...
    for i in momRange:
        ...
        dfHitLabelTemp = dfHitLabelTemp[['hitTime','hitPosX', 'hitPosY', 'hitPosZ','hitR', 'hitAngle', 'eDep','hitPMag', 'label']]
    ...
    for i in label:
        ...
        dfHitRefer.columns = ['hitTime','hitPosX', 'hitPosY', 'hitPosZ','hitR', 'hitAngle','eDep','hitPMag', 'label']
        #dfHitLabelLen.columns = ['hitTime','hitPosX', 'hitPosY', 'hitPosZ','hitR', 'hitAngle' ,'label']
        dfHitLabelLen.columns = ['hitTime','hitPosX', 'hitPosY', 'hitPosZ','hitR', 'hitAngle','eDep' ,'hitPMag','label']
    ...
    print('dfHitLabelCalib')
    print(dfHitLabelCalib)
    signal = dfHitLabelCalib[(dfHitLabelCalib['hitPMag'] >= 200) &  (dfHitLabelCalib['hitPMag'] <= 275) ]
    noise = dfHitLabelCalib[(dfHitLabelCalib['hitPMag'] < 200) |  (dfHitLabelCalib['hitPMag'] > 275) ]
    signal = signal[signal.columns.difference(['hitMag'])]
    noise = noise[noise.columns.difference(['hitMag'])]
    signal['label'] = 1
    noise['label'] = 0
    return signal, noise