...
#for i in (0,10)
#    data[i] = windowsPlotSel(dfPosi, i)
#
#
#    eveID = testPlot1["eventID"]
...
#    
#    timeMin = testPlot["hitTime"].min()
#    timeMax = testPlot["hitTime"].max()
#    
...
#    
# 
#    def plotting(data, eveID, trackIter):
#        c_list = colorList(100)
#        pos3D.scatter(data["hitPosX"],data["hitPosY"],data["hitPosZ"], color='black', s= 20)
#        pos2DXY.scatter(data["hitPosX"],data["hitPosY"], color='black', s= 20)
#        pos2DVZ.scatter(data["VolID"],data["hitPosZ"], color='black', s= 20)
#        pos2DVT.scatter(data["VolID"],data["hitTime"], color='black', s= 20)
#        eveID = eveID.values
...
#    
#    
#    dfSel, eveSel, xS, yS, zS, volIDs, hitTimes = plotting(testPlot, eveID, i)
#   
#    #print('dfSel11')
#    #print(dfSel11)
#    #print('dfSel12')
...
#        
#    trackLabel(eveID, xS, yS, zS, volIDs, hitTimes)        
#
#    
#
#    def plotSel(dfSel):  
#        pos3D.scatter(dfSel["hitPosX"],dfSel["hitPosY"],dfSel["hitPosZ"], color='black', linestyle= 'dashed', marker='o')
#        pos2DXY.scatter(dfSel["hitPosX"],dfSel["hitPosY"], color='black', linestyle= 'dashed', marker='o')
#        pos2DVZ.scatter(dfSel["VolID"],dfSel["hitPosZ"], color='black', linestyle= 'dashed', marker='o')
#        pos2DVT.scatter(dfSel["VolID"],dfSel["hitTime"], color='black', linestyle= 'dashed', marker='o')
#        pos2DVT.axhline(y=winMax*5e-3, color='r', linewidth=1)
#
#
#
#    plotSel(dfSel)
